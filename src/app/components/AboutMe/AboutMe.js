...
function AboutMe(props) {
    ...
    return ( <
        ...
        target = "blank" > BUET < /a>
        and expecting to complete graduation by January, 2021. My major is in
        <
        a className = { classes.link }
        href = "https://cse.buet.ac.bd/"
        target = "blank" > Computer Science and Engineering. < /a> <
        br / > < br / > I am currently working in < b > LEADS Corporation Limited < /b> as < b> Software Engineer</b > . <

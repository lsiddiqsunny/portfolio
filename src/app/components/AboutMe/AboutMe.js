				...
				<div className={classes.mobile}>
					<div className={classes.mobilePara}>
						<p>Hi! I'm Latif. I am in the final year of my undergrad course at
							...
							<br /><br />I am currently working on a group project called <i>DhashtoSheba</i> that will help to connect doctor and patient from remote arae. The ui will also be in Bangla so that native Bengali kids finds it easier to learn.

				...
				<div className={classes.mobile}>
					<div className={classes.mobilePara}>
						<p>Hi! I'm Latif. I am in the final year of my undergrad course at
							...
							<br /><br />I am currently working on a group project called <i>ShashtoSheba</i> that telemedicine application will help to connect doctor and patient from remote arae.
